...
| [prompt9.md](prompt9.md) | Swarm drafting: cells, layers, jury vs the control; X fitness and pruning; breeding and designers; panel /swarm | merged (PR #86, phases 1-2) + follow-up PR (phase 3) |
